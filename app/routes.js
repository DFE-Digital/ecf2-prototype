...
require('./routes/v22')(router)
require('./routes/v23')(router)
require('./routes/v24')(router)
require('./routes/v25')(router)
require('./routes/v26')(router)
require('./routes/v27')(router)